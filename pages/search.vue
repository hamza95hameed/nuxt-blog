                                        ...
                                        <div class="post-content">
                                             <div class="entry-meta meta-0 font-small mb-10">
                                                <nuxt-link :to="{ name: 'category-slug', params: { slug: $common.getCategory(post).toLowerCase() }}">
                                                    <span class="post-cat text-uppercase" :style="'color:#'+color">{{ $common.getCategory(post) }}</span>
                                                </nuxt-link>                               
                                            </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            async asyncData() {
                let posts = await this.$axios.get('/posts?search='+this.$route.query.s, { params: this.queryOptions })
